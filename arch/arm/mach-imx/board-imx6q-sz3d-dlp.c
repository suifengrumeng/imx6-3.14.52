...
/***********************************************/
#define ILI9488_LG35_GPIO_RESET 	IMX_GPIO_NR(1, 27)
#define ILI9488_LG35_GPIO_BACKLIGHT IMX_GPIO_NR(4, 10)
#define ILI9488_LG35_GPIO_SPI_CS	IMX_GPIO_NR(1, 17)
#define ILI9488_LG35_GPIO_SPI_CLK	IMX_GPIO_NR(1, 20)
#define ILI9488_LG35_GPIO_SPI_DATA	IMX_GPIO_NR(1, 18)
...
static void lcd_gpio_init(void)
{
	...
	status = gpio_request(ILI9488_LG35_GPIO_BACKLIGHT, "lcd backlight\n");
	if (status < 0)
	{
		pr_err("Failed to request gpio for lcd backlight");
		return;
	}
	gpio_direction_output(ILI9488_LG35_GPIO_BACKLIGHT, 1);
/*
	gpio_set_value(ILI9488_LG35_GPIO_BACKLIGHT, 1);
    mdelay(1000);
	gpio_set_value(ILI9488_LG35_GPIO_BACKLIGHT, 0);	
    mdelay(1000);
...
static void lcd_gpio_clear(void)
{
	...
	gpio_free(ILI9488_LG35_GPIO_BACKLIGHT);	
}

static void ILI9488_LG35_spi_write_cmd_byte(unsigned int i)
{ 
    unsigned char n,m;
...
static void ILI9488_LG35_spi_write_data_byte(unsigned int i)
{ 
    unsigned char n,m;
...
static void ILI9488_LG35_Initial_Code(void) 
{
	// VCI=2.8V 
	/************* Reset LCD Driver ***************
	LCD_nRESET = 1; 
	...
	ILI9488_LG35_spi_write_cmd_byte(0xE0); //P-Gamma
	ILI9488_LG35_spi_write_data_byte(0x00);
	ILI9488_LG35_spi_write_data_byte(0x13);
	ILI9488_LG35_spi_write_data_byte(0x18);
	ILI9488_LG35_spi_write_data_byte(0x04);
	ILI9488_LG35_spi_write_data_byte(0x0F);
	ILI9488_LG35_spi_write_data_byte(0x06);
	ILI9488_LG35_spi_write_data_byte(0x3A);
	ILI9488_LG35_spi_write_data_byte(0x56);
	ILI9488_LG35_spi_write_data_byte(0x4D);
	ILI9488_LG35_spi_write_data_byte(0x03);
	ILI9488_LG35_spi_write_data_byte(0x0A);
	ILI9488_LG35_spi_write_data_byte(0x06);
	ILI9488_LG35_spi_write_data_byte(0x30);
	ILI9488_LG35_spi_write_data_byte(0x3E);
	ILI9488_LG35_spi_write_data_byte(0x0F);

	ILI9488_LG35_spi_write_cmd_byte(0XE1); //N-Gamma
	ILI9488_LG35_spi_write_data_byte(0x00);
	ILI9488_LG35_spi_write_data_byte(0x13);
	ILI9488_LG35_spi_write_data_byte(0x18);
	ILI9488_LG35_spi_write_data_byte(0x01);
	ILI9488_LG35_spi_write_data_byte(0x11);
	ILI9488_LG35_spi_write_data_byte(0x06);
	ILI9488_LG35_spi_write_data_byte(0x38);
	ILI9488_LG35_spi_write_data_byte(0x34);
	ILI9488_LG35_spi_write_data_byte(0x4D);
	ILI9488_LG35_spi_write_data_byte(0x06);
	ILI9488_LG35_spi_write_data_byte(0x0D);
	ILI9488_LG35_spi_write_data_byte(0x0B);
	ILI9488_LG35_spi_write_data_byte(0x31);
	ILI9488_LG35_spi_write_data_byte(0x37);
	ILI9488_LG35_spi_write_data_byte(0x0F); 

	ILI9488_LG35_spi_write_cmd_byte(0XC0);   //Power Control 1
	ILI9488_LG35_spi_write_data_byte(0x18); //Vreg1out
	ILI9488_LG35_spi_write_data_byte(0x17); //Verg2out

	ILI9488_LG35_spi_write_cmd_byte(0xC1);   //Power Control 2
	ILI9488_LG35_spi_write_data_byte(0x41); //VGH,VGL

	ILI9488_LG35_spi_write_cmd_byte(0xC5);   //Power Control 3
	ILI9488_LG35_spi_write_data_byte(0x00);
	ILI9488_LG35_spi_write_data_byte(0x1A); //Vcom
	ILI9488_LG35_spi_write_data_byte(0x80);

	ILI9488_LG35_spi_write_cmd_byte(0x36);   //Memory Access
	ILI9488_LG35_spi_write_data_byte(0x48);   //48

	ILI9488_LG35_spi_write_cmd_byte(0x3A);   // Interface Pixel Format
	ILI9488_LG35_spi_write_data_byte(0x66); //18bit

	ILI9488_LG35_spi_write_cmd_byte(0XB0);   // Interface Mode Control
	ILI9488_LG35_spi_write_data_byte(0x00);

	ILI9488_LG35_spi_write_cmd_byte(0xB1);   //Frame rate
	ILI9488_LG35_spi_write_data_byte(0xA0); //60Hz

	ILI9488_LG35_spi_write_cmd_byte(0xB4);   //Display Inversion Control
	ILI9488_LG35_spi_write_data_byte(0x02); //2-dot

	ILI9488_LG35_spi_write_cmd_byte(0XB6);   //RGB/MCU Interface Control
	ILI9488_LG35_spi_write_data_byte(0x32); //MCU RGB
	ILI9488_LG35_spi_write_data_byte(0x02); //Source,Gate scan dieection

	ILI9488_LG35_spi_write_cmd_byte(0XE9);    // Set Image Function
	ILI9488_LG35_spi_write_data_byte(0x00);  //disable 24 bit data input

	ILI9488_LG35_spi_write_cmd_byte(0xF7);    // Adjust Control
	ILI9488_LG35_spi_write_data_byte(0xA9);
	ILI9488_LG35_spi_write_data_byte(0x51);
	ILI9488_LG35_spi_write_data_byte(0x2C);
	ILI9488_LG35_spi_write_data_byte(0x82);  // D7 stream, loose

	ILI9488_LG35_spi_write_cmd_byte(0x21);    //Normal Black
	ILI9488_LG35_spi_write_cmd_byte(0x11);    //Sleep out
	mdelay(120);
	ILI9488_LG35_spi_write_cmd_byte(0x29);  
} 
