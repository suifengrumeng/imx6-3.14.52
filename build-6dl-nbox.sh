...
cp -rf 6dl_nbox.config .config 
make -j8 zImage

#dtb
make imx6dl-nbox-ldo.dtb 

cp -vf arch/arm/boot/zImage /home/suifeng/XP-UBUNTU/zImage_nbox
cp -vf arch/arm/boot/dts/imx6dl-nbox-ldo.dtb /home/suifeng/XP-UBUNTU/imx6dl-nbox-ldo.dtb
