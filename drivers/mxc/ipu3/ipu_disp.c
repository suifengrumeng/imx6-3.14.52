...
void _ipu_init_dc_mappings(struct ipu_soc *ipu)
{
	...
	_ipu_dc_map_config(ipu, 1, 0, 17, 0xFC); //BGR666
    //_ipu_dc_map_config(ipu, 1, 0, 5, 0xFC);  //RGB666 ,src
	_ipu_dc_map_config(ipu, 1, 1, 11, 0xFC);
    _ipu_dc_map_config(ipu, 1, 2, 5, 0xFC);  //BGR666 
	//_ipu_dc_map_config(ipu, 1, 2, 17, 0xFC); //RGB666 ,src
