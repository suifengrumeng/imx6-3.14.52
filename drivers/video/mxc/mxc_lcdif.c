...
static struct fb_videomode lcdif_modedb[] = {
    ...
    {
    /* 320*480 @ 60 Hz , pixel clk @ 32MHz */
//    "TFT_STD4802", 60, 320, 480, 39850, 16, 8, 2, 16, 2, 2,
    "TFT_STD4802", 60, 320, 480, 44850, 16, 8, 2, 16, 2, 2,
//     FB_SYNC_CLK_LAT_FALL,
     FB_SYNC_CLK_IDLE_EN,                           //FB_SYNC_DATA_INVERT,
     FB_VMODE_NONINTERLACED,
    0,},
    {
    /* 320*480 @ 60 Hz , pixel clk @ 32MHz */
    "TFT_FN043", 60, 480, 800, 32000, 46, 44, 15, 16, 4, 1,
     FB_SYNC_CLK_IDLE_EN,                         //FB_SYNC_CLK_LAT_FALL,
     FB_VMODE_NONINTERLACED,
    0,},
     {
    /* 320*480 @ 60 Hz , pixel clk @ 32MHz */
    "1200X1920", 60, 1200, 1920, 5000, 46, 44, 15, 16, 4, 1,
     FB_SYNC_CLK_IDLE_EN,                         //FB_SYNC_CLK_LAT_FALL,
     FB_VMODE_NONINTERLACED,
    0,},
